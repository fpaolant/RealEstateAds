...
@Component({
    ...
    template: ` <div class="layout-topbar">
        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block" *ngIf="!this.authService.isLogged()">
                <div class="layout-topbar-menu-content">
                    <button type="button" class="layout-topbar-action" (click)="onAccountClick()">
            ...
            <div class="layout-topbar-menu hidden lg:block" *ngIf="this.authService.isLogged()">
                <div class="layout-topbar-menu-content">
                    ...
                    <button type="button" class="layout-topbar-action" label="Options" (click)="menu.toggle($event)">
                        <i class="pi pi-user"></i>
                        &nbsp;{{ username || '' }}&nbsp;

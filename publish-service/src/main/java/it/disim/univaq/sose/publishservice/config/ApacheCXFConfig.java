package it.disim.univaq.sose.publishservice.config;
...
public class ApacheCXFConfig {
    ...
    public OpenApiFeature createOpenApiFeature() {
        ...
        openApiFeature.setTitle("Publish Ads Service API");
        openApiFeature.setContactName("System team");
        openApiFeature.setDescription("This is Publish Ads Service. Uses Apache CXF and Spring Boot on JAX-RS.");
        openApiFeature.setPrettyPrint(true);
